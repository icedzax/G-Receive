...
public class ReceivePoP1 extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if (tab_hn == null) {
                    AlertDialog.Builder builder =
                            new AlertDialog.Builder(ReceivePoP1.this);
    ...
    public class AddProScan extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String r) {
            ...
            if (isSuccess == true) {
                ...
                Toast.makeText(ReceivePoP1.this, z, Toast.LENGTH_SHORT).show();
            } else {
    ...
    public class FillList extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String r) {
            ...
            final SimpleAdapter ADA = new SimpleAdapter(ReceivePoP1.this,
    ...
    public class AdjItem extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String r) {
            ...
            Toast.makeText(ReceivePoP1.this, r, Toast.LENGTH_SHORT).show();
    ...
    public void adjQty(String hn, int qty, final Double weight){
        ...
        final Dialog adjdialog = new Dialog(ReceivePoP1.this);
    ...
    public void onLocationClick(View v) {
        ...
        final Dialog spndialog = new Dialog(ReceivePoP1.this);
