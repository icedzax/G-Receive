...
public class ReceiveTransfSpn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_receive_transf_spn);
            ...
            public void onClick(View v) {
                ...
                if (tab_hn == null) {
                    AlertDialog.Builder builder =
                            new AlertDialog.Builder(ReceiveTransfSpn.this);
    ...
    public class AddProScan extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String r) {
            ...
            //Toast.makeText(ReceiveTransfSpn.this,xx,Toast.LENGTH_SHORT).show();
            if(isSuccess==true) {

                FillList fillList = new FillList();
                fillList.execute((g_vbeln.trim().substring(0,g_vbeln.trim().indexOf("-"))),g_posnr.trim());

                Toast.makeText(ReceiveTransfSpn.this, z, Toast.LENGTH_SHORT).show();
            }else{
    ...
    public class FillList extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String r) {
            ...
            final SimpleAdapter ADA = new SimpleAdapter(ReceiveTransfSpn.this,
            ...
            //Toast.makeText(ReceiveTransfSpn.this, start+"-"+end, Toast.LENGTH_SHORT).show();
    ...
    public class AdjItem extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String r) {
            ...
            Toast.makeText(ReceiveTransfSpn.this, r, Toast.LENGTH_SHORT).show();
    ...
    public void adjQty(String hn, int qty, final Double weight){
        ...
        final Dialog adjdialog = new Dialog(ReceiveTransfSpn.this);
    ...
    public  void  onLocationClick(View v){
        ...
        final Dialog spndialog = new Dialog(ReceiveTransfSpn.this);
    ...
    public  void  onPilClick(View v){
        ...
        final Dialog dialog = new Dialog(ReceiveTransfSpn.this);
