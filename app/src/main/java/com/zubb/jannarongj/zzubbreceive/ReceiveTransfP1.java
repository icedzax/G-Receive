...
public class ReceiveTransfP1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_receive_transf_p1);
            ...
            public void onClick(View v) {
                ...
                if (tab_hn == null) {
                    AlertDialog.Builder builder =
                            new AlertDialog.Builder(ReceiveTransfP1.this);
    ...
    public class AddProScan extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String r) {
            ...
            if(isSuccess==true) {
                ...
                Toast.makeText(ReceiveTransfP1.this, z, Toast.LENGTH_SHORT).show();
            }else{
    ...
    public class FillList extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String r) {
            ...
            final SimpleAdapter ADA = new SimpleAdapter(ReceiveTransfP1.this,
    ...
    public class AdjItem extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String r) {
            ...
            Toast.makeText(ReceiveTransfP1.this, r, Toast.LENGTH_SHORT).show();
    ...
    public void adjQty(String hn, int qty, final Double weight){
        ...
        final Dialog adjdialog = new Dialog(ReceiveTransfP1.this);
    ...
    public  void  onLocationClick(View v){
        ...
        final Dialog spndialog = new Dialog(ReceiveTransfP1.this);
    ...
    public  void  onPilClick(View v){
        ...
        final Dialog dialog = new Dialog(ReceiveTransfP1.this);
