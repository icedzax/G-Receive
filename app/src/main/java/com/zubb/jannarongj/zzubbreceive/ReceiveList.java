...
public class ReceiveList extends AppCompatActivity implements TextWatcher {
    ...
    public class VbelnFList extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String r) {
            ...
            ADA = new SimpleAdapter(ReceiveList.this,
            ...
            list_vbeln.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> arg0, View arg1,
                    ...
                    if(usrHelper.getPlant().equals("SPN")){
                        Intent i = new Intent(ReceiveList.this, ReceiveTransfSpn.class);
                        i.putExtra("vbeln", (String) obj.get("VBELN"));
                        i.putExtra("posnr", (String) obj.get("POSNR"));
                        startActivity(i);
                    }else{
                        Intent i = new Intent(ReceiveList.this, ReceiveTransf.class);
                        i.putExtra("vbeln", (String) obj.get("VBELN"));
                        i.putExtra("posnr", (String) obj.get("POSNR"));
                        startActivity(i);
                    }
                    ...
                    //Toast.makeText(this, (String) obj.get("POSNR"), Toast.LENGTH_SHORT).show();
